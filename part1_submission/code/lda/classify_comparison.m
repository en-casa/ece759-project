function [acc_test acc_train] = classify_comparison(total_classes,num_neighbors, mean_vector, cov_each_class, test_data, test_label, train_data,  train_label)
%
% Description:  
